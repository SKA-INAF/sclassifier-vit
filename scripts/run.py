...
def get_args():
	...
	parser.add_argument('-label_schema', '--label_schema', dest='label_schema', required=False, type=str, default='morph_tags', action='store',help='Predefined label schema to be used. For multilabel class: {"morph_tags","morph_tags_B1"}. For single-label classification: {"morph_tags","morph_class","binary_qa","anomaly_class","rg_morph_binary","rg_morph","rg_morph_v2"} (default=morph_tags)')
